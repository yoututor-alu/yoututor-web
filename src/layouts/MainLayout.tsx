...
const MainLayout = () => {
  ...
  return (
    <div className="h-screen flex flex-col bg-[#fafafa] overflow-hidden">
      {/* Fixed Header */}
      <ChatHeader
        title={isHomePage ? "Learn smarter with YouTutor" : "Interactive Session"}
        subtitle={isHomePage ? "Turn any YouTube video into an interactive lesson in seconds." : undefined}
        showMenuButton={true}
        showSettingsButton={!isHomePage}
